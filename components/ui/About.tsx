  ...
  return (
    <div className="mt-14 max-w-[1024px] mx-auto flex flex-col lg:flex-row items-center gap-12">
      ...
      <div className="max-w-[515px] text-center lg:text-left">
        ...
        <p className="text-gray text-base md:text-lg leading-relaxed mb-4">
          I’m a self-taught front-end developer who builds responsive, modern
          web applications with clean and maintainable code.
        </p>

        <p className="text-gray text-base md:text-lg leading-relaxed mb-6">
          I enjoy turning ideas into real products and continuously learning new
        ...
        {pathname === "/" && (
          <button
            ...
            className="border border-primary px-4 py-2 text-white hover:bg-primary/20 transition"
          >
            Read More →
          </button>
        )}
